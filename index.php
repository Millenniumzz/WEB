...
<body>
    ...
    <div class="container-fluid mt-3">
        <div class="dropdown">
            ...
            <button class="btn dropdown-toggle" data-bs-toggle="dropdown">ทั้งหมด</button>
            ...
            if(isset($_SESSION['id'])){
                echo "<a href='newpost.php' class='btn btn-success' style='float:right;' >+ สร้างกระทู้ใหม่</a>";}
            ?>
    </div>                    
